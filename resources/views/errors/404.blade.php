...
<head>
    ...
    <title>404 Not Found - {{ config('app.name', 'Aplikasi Anda') }}</title>
    <!-- Google Font: Source Sans Pro -->
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('adminlte/plugins/fontawesome-free/css/all.min.css') }}">
    <!-- AdminLTE style (opsional, jika ingin konsisten dengan style AdminLTE) -->
    ...
    <div class="error-container">
        <div class="error-box">
            ...
            <h3 class="error-title">
                <i class="fas fa-exclamation-circle text-danger"></i> Not Found
            </h3>
            <p class="error-desc">
