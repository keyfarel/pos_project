<!-- File: resources/views/supplier/import.blade.php -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title mb-0">
                    <i class="fa fa-upload mr-2"></i> Import Data Supplier
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3 border-info">
                    <div class="card-body p-2">
                        ...
                        <ul class="mb-2">
                            <li>Kolom A: <strong>supplier_kode</strong></li>
                            <li>Kolom B: <strong>supplier_nama</strong></li>
                            <li>Kolom C: <strong>supplier_alamat</strong></li>
                        </ul>
                        <a href="{{ asset('assets/templates/template_supplier.xlsx') }}"
                ...
                <div class="form-group">
                    <label for="file_supplier" class="font-weight-bold">File Excel (.xlsx)</label>
